...
import { Options, OptionsKeys } from '../src/types/options';
import textOptionsJSON from '../src/assets/textoptions.json';
import Link from 'next/link';
import getRandomSample from '../src/helpers/random';
...
const Home: NextPage = () => {
  const links = [
    <Link key="dev" href="/developer">
      <a>web developer</a>
    </Link>,
    <Link key="wri" href="/writer">
      <a>writer</a>
    </Link>,
    <Link key="dru" href="/drummer">
      <a>drummer</a>
    </Link>,
  ];
  ...
  return (
    <article className={style.Home}>
      ...
      <div className={style['emoji-row']}>
        <figure className={style.emoji} style={emojiStyle}>
          {emoji.content}
