...
function Developer() {
  return (
    <div className="Developer">
      <p>
        I'm a Front-End Engineer with a Master's Degree in Computer Science and
        more than 10 years of experience in Web Development. During these 10
        years, I've been a Full Stack developer, working with many different
        technologies, and a couple of years ago I decided to focus on Front-End
        Development, so I have professional experience with Angular, React, and
        React Native.
      </p>
      <p>
        ...
        over the world. During the last couple of years I've also colaborated
        with international teams, working remotely with coleagues from Brazil,
        US, Ireland, and India.
      </p>
      <p>
      ...
      <p>
        ...
        <a href={cv} download="FabricioJCMontenegro-CV.pdf">
          here
        </a>
        .
      </p>
